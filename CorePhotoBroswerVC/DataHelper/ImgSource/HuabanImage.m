...
-(NSArray * ) getFollowList{
    ...
    //ios不能有色情的内容
    [b removeAllObjects];
    NSString *fanbinbin = @"http://huaban.com/boards/14420976/";//范彬彬
    [b addObject:@"http://huaban.com/boards/23979438/"];//杨颖angelbaby
    [b addObject:@"http://huaban.com/boards/17378095/"];//小清新
    
    [b addObject:@"http://huaban.com/boards/16284567/"];//小清新
    [b addObject:@"http://huaban.com/boards/19219899/"];//佟丽娅
    [b addObject:@"http://huaban.com/boards/24325777/"];//阳光少女
    

    [b addObject:fanbinbin];
    //只显示
    
    NSDictionary * dic = [[DataHolder sharedInstance]getBoardFollows];
